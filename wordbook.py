...
class Wordbook:
    ...
    def extract_corpora(self, candidate_extractor):
        for a, c in self.file_list:
            ...
            try:
                a_ners, a_candidates = candidate_extractor.extract(preprocessing(about_text))
                c_ners, c_candidates = candidate_extractor.extract(preprocessing(content_text))
            ...
            word_list = {word for sent in doc for word in sent}
